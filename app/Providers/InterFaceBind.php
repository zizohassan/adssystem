...
class InterFaceBind extends ServiceProvider
{
    public function register()
    {
        ...
        $this->app->bind(
            'App\Application\Repository\InterFaces\ProductInterface',
            'App\Application\Repository\Eloquent\ProductEloquent'
        );

        $this->app->bind(
            'App\Application\Repository\InterFaces\ProductWebsiteInterface',
            'App\Application\Repository\Eloquent\ProductWebsiteEloquent'
        );
